...
native_first_paint <- read.csv("/Users/tjarco/Development/thesis-pwa/iOS/measurements/data/iOS_first_paint_native.csv")
...
native <- native_first_paint$First.Paint.time.in.ms
