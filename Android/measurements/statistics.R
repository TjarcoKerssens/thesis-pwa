...
if (ttest$p.value > CONFIDENCE){
  print("t-test 30 min: The average energy consumption of PWAs and Native apps does not differ")
}else{
  print(sprintf("t-test 30 min: The average energy consumption of PWAs and Native apps does differ, p-value: %f", ttest$p.value))
}

if (wtest$p.value > CONFIDENCE){
  print("Wilcox 30 min: The average energy consumption of PWAs and Native apps does not differ")
}else{
  print(sprintf("Wilcox 30 min: The average energy consumption of PWAs and Native apps does differ, p-value: %f", wtest$p.value))
}
